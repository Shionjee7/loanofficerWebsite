...
function Nav() {
  ...
  const links = ["Loans", "Process", "Calculator", "About"];
    ...
    <nav style={{
      ...
      <div className="container nav-inner" style={{
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <a href="https://1922182.my1003app.com" target="_blank" rel="noopener noreferrer" className="btn btn-accent nav-apply-mobile" style={{ fontSize: 13, fontWeight: 600, padding: "10px 18px", display: "none", letterSpacing: "0.01em" }}>Apply</a>
          ...
          <button
            ...
            style={{
              display: "none", background: open ? "var(--primary)" : "transparent",
              border: "1px solid", borderColor: open ? "var(--primary)" : "var(--hairline)",
